...
namespace GenClinic
{
    public partial class Kashf : Form
    {
        //***********************
        ...
        //======================
        private void Kashf_Load(object sender, EventArgs e)
        {
            //=========
            FillKashfFlageName();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            printPreviewDialog1.SetBounds(50, 20, this.Width, this.Height);
        ...
        private void txt_MedcinName_TextChanged(object sender, EventArgs e)
        {

        }

        private void printPreviewDialog5_Load(object sender, EventArgs e)
        {
