...
namespace GenClinic
{
    public partial class HagzReportBetweenTwoDates : Form
    {
        //***********************
        ...
        //***************
        public HagzReportBetweenTwoDates()
        {
            InitializeComponent();
        }
        //===========================
        private void HagzReportBetweenTwoDates_Load(object sender, EventArgs e)
        {
            //------------
        ...
        private void Searc_OrderAll(DateTime begindate1, DateTime enddate1)
        {
            ...
            cmd.CommandText = "SelecHagzOrder_FromDate_toDate";
            //***********************  *************            
            ...
            for (int i = 0; i < dataTable.Rows.Count; i++)
            {
               ...
               dataGridView1.Rows.Add(HagzOrderId, PatiantId, KashfDate, PatiantName, KashfFlageName);
                //====
        ...
        private void Searc_Order_KashfFlage(DateTime begindate1, DateTime enddate1, int KashfFlage)
        {
            ...
            cmd.Connection = con;
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.CommandText = "Selec_HagzOrder_KashfFlage_FromDatetoDate";
            //***********************  *************            
            SqlParameter param2 = new SqlParameter("@bigenDate", SqlDbType.DateTime);
            param2.Value = begindate1;
            param2.Direction = ParameterDirection.Input;
        ...
        private void delete_ZtempTest10() 
        {
            ...
            cmd.ExecuteNonQuery();
            con.Close(); con.Dispose(); SqlConnection.ClearPool(con);

        }
        //================================== 
        private void insert_ZtempTest10(int count, string kasf_Date, string Name, string flag)
        {
            SqlConnection con = new SqlConnection(stringconPrint);
            con.Open();
            SqlCommand cmd = new SqlCommand();
        ...
        private void insert_ZtempTest10All()
        {
            ...
            for (int i = 0; i < dataGridView1.Rows.Count; i++)
            {
                ...
                //=======================
                count = count + 1;
                kasf_Date = displaydate(Convert.ToDateTime(dataGridView1.Rows[i].Cells[2].Value.ToString()));
                Name = dataGridView1.Rows[i].Cells[3].Value.ToString();
                flag = dataGridView1.Rows[i].Cells[4].Value.ToString();
                

                //==================
                insert_ZtempTest10(count, kasf_Date, Name, flag);
                //===========================
            }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            //cmd.Connection = con;
           // cmd.CommandType = CommandType.Text;
           // cmd.CommandText = "delet * FROM KashfFlageTable where (Trash=" + 0 + ") order by  KashfFlage";
        ...
        private void bt_Print_Click(object sender, EventArgs e)
        {
            ...
            //===============
            hagz_report2_Form hagz_report2_Form1 = new hagz_report2_Form();
            hagz_report2_Form1.Show();
            //==========
        }
